...
image_icon = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/Internet Speed test/Images/logo.png")
root.iconphoto(False, image_icon)

# Images
Top = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/Internet Speed test/Images/top.png")

Label(root, image=Top, bg="#1a212d").pack()

Main = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/Internet Speed test/Images/main.png")

Label(root, image=Main, bg="#1a212d").pack(pady=(20, 0))

button = PhotoImage(
    file="C:/Users/vaska/OneDrive/Desktop/Python/Internet Speed test/Images/button.png")
Button = Button(root, image=button, bg="#1a212d", bd=0,
                activebackground="#1a212d", cursor="hand2", command=Check)
Button.pack(pady=(10))
